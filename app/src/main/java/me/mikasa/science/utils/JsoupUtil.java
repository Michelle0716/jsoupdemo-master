...
public class JsoupUtil {
    ...
    public List<SongShu>getSongShu(String s){
        ...
        for (int i=1;i<es.size()-1;i++){
            ...
            Log.e("jsoup","1: "+ee.child(1));
            Log.e("jsoup","2: "+ee.child(1).child(0));
            Log.e("jsoup","3.1: "+ee.child(1).child(0).child(0));
            Log.e("jsoup","3: "+ee.child(1).child(0).child(0).text());
            Log.e("jsoup","4: "+ee);
